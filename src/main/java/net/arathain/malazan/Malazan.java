...
public class Malazan implements ModInitializer {
	...
	public static final EntityType<FlareEntity> FLARE = createEntity("mordicant", FlareEntity.createAttributes(), FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, FlareEntity::new).dimensions(EntityDimensions.fixed(0.6f, 1.9f)).fireImmune().build());
